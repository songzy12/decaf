...
public abstract class Tree {
    ...
    public static final int REPEAT = FORLOOP + 1;
    
    public static final int UNTIL = REPEAT + 1;
    
    /**
     * Labelled statements, of type Labelled.
     */
    public static final int LABELLED = UNTIL + 1;
    ...
    public static class Repeat extends Tree{
    	...
    	public Repeat(Tree stmt, Expr expr, Location loc){
    		super(REPEAT, loc);
            this.stmt = stmt;
    		this.expr = expr;
    	}
    ...
    /**
     * A Swtich ( ) case : default: clause
     */
    public static class Switch extends Tree {

    	public Expr expr;
    	public List<Tree> caseList;
    	public Tree defaultClause;
    	public LocalScope associatedScope;

        public Switch(Expr expr, List<Tree> caseList, Tree defaultClause, Location loc) {
            super(SWITCH, loc);
            this.expr = expr;
    ...
    public static class Case extends Tree {
        ...
        public Case(Expr expr, List<Tree> slist, Location loc) {
            super(CASE, loc);
            this.expr = expr;
            this.slist = slist;
        }
    ...
    public static class DefaultClause extends Tree {

    	public List<Tree> slist;

        public DefaultClause(List<Tree> slist, Location loc) {
            super(DEFAULT, loc);
            this.slist = slist;
        }
    ...
    public static class CondExpr extends Expr {
    	...
    	public CondExpr(Expr cond, Expr left, Expr right, Location loc) {
    		super(CONDEXPR, loc);
    		this.cond = cond;
    		this.left = left;
    		this.right = right;
    ...
    public static class Preinc extends Expr {
    	...
    	public Preinc(Expr expr, Location loc) {
    		super(PREINC, loc);
    		this.expr = expr;
    	}
    	@Override
    ...
    public static class Postinc extends Expr {
    	...
    	public Postinc(Expr expr, Location loc) {
    		super(POSTINC, loc);
    		this.expr = expr;
    	}
    	@Override
    ...
    public static class Predec extends Expr {
    	...
    	public Predec(Expr expr, Location loc) {
    		super(PREDEC, loc);
    		this.expr = expr;
    	}
    	@Override
    ...
    public static class Postdec extends Expr {
    	...
    	public Postdec(Expr expr, Location loc) {
    		super(POSTDEC, loc);
    		this.expr = expr;
    	}
    	@Override
    ...
    public static abstract class Visitor {
		...
		public void visitDefaultClause(DefaultClause that) {
			visitTree(that);
		}
